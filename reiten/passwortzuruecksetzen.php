...
//Abfrage des Nutzers
$statement = $pdo->prepare("SELECT * FROM users_reiten WHERE id = :userid");
...
if(isset($_GET['send'])) {
	...
	if($passwort != $passwort2) {
		...
		$statement = $pdo->prepare("UPDATE users_reiten SET passwort = :passworthash, passwortcode = NULL, passwortcode_time = NULL WHERE id = :userid");
